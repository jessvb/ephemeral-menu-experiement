...
TODO ADD:  Each distinct task is clearly presented to the user, with appropriate instructions
--> "As shown in the video, there are two main tasks: 1. Evaluate the regular menu. 2. Evaluate the menu with fading items. These tasks may come in either order (regular menu first, fading menu second or vice versa). As shown in the video, the prompt tells you which menu to click on and which item within that menu to click on. Once you complete a certain number of these tests, you will be shown a survey. Then you will be asked to complete these tests again for the opposite type of menu, and complete anothe survey. Finally, you will be asked to compare the two menus.

TODO ADD: Demographic info --> OS + mouse / trackpad
